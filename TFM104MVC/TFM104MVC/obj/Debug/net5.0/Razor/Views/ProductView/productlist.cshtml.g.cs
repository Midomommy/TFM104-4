#pragma checksum "C:\Users\Tibame_T14\Documents\GitHub\TFM104-4\TFM104MVC\TFM104MVC\Views\ProductView\productlist.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ed8c8743515966e3b845760e4f5a938b89252c14"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ed8c8743515966e3b845760e4f5a938b89252c14", @"/Views/ProductView/productlist.cshtml")]
            ...
            <div id=""app"" v-for=""(item, index) in productList.slice(pageStart, pageStart + countOfPage)"" :key=""index"">
                <div class=""card mb-3"">
                    <div class=""row g-0"">
                        ...
                        <div class=""col-md-8"">
                            <div class=""card-body"">
                                <a v-bind:href="" '/ProductView/product/ '+ it");
            WriteLiteral(@"em.id "" target=""_blank"" rel=""noopener"">
                                ...
                                <!--產品資訊：地點&日期-->
                                <a v-bind:href="" '/ProductView/product/");
            WriteLiteral(@" '+ item.id "" target=""_blank"" rel=""noopener"">
                                ...
                                <!--產品資訊：評價&熱門程度&價格-->
         ");
            WriteLiteral(@"                       <a href=""#product-footer "" target=""_blank"" rel=""noopener"">
                                    <div class=""product-footer d-flex gap-3 position-absolute bottom-0 "">
                                        ...
                                        <div class=""prodcut-book d-flex gap-1 text-danger"">
                                            ...
                                            <p><small c");
            WriteLiteral(@"lass=""text-muted"">xxxx個已訂購</small></p>
                                        </div>
                                        <!--價格-->
...
<script>
 ...
 ");
            ...
            regionClick: function () {
                ...
                axios.get(""/api/products?Re");
            WriteLiteral(@"gion="" + regionValue + ""&Traveldays="" + Traveldays + ""&Triptype="" + Triptype).then(function (res) {
                    self.productList = res.data;
                    self.error = """";
                    self.currPage = ""1"";
                    self.productTotal = res.data.length;
        ...
        //        if (a == false) {
        //            axios.get(""/api/pro");
            WriteLiteral("ducts\").then(function (res) {\r\n        //                self.productList = res.data;\r\n        //            })\r\n        //        }\r\n        //        }\r\n        //    }\r\n    });\r\n</script>");
        }
