#pragma checksum "C:\Users\Tibame_T14\Documents\GitHub\TFM104-4\TFM104MVC\TFM104MVC\Views\Purchase\booking.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2e5598a5f2fd9b0f057d60e1981337991f67ed17"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2e5598a5f2fd9b0f057d60e1981337991f67ed17", @"/Views/Purchase/booking.cshtml")]
                ...
                axios.post(""/api/Cart/Checkout"", self.orderInformation)
                    .then(function (res) {
                        if (res.status == 200) {
                            ...
                            //訂單編號
      ");
            WriteLiteral(@"                      var inp1 = document.createElement(""input"");
                            inp1.type = ""text"";
                        ...
                        for (let i in item) {
                            for (let z = 0; z < res.data.length; z++) {
                                ...
                                if (res.data[z].id == item[i]) {
                                    ...
                                    //self.checkOu");
            WriteLiteral(@"tList[self.checkOutList.length] = res.data[i];
                                }
                            }
                        }
                    })
