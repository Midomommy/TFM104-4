#pragma checksum "C:\Users\Tibame_T14\Documents\GitHub\TFM104-4\TFM104MVC\TFM104MVC\Views\Purchase\booking.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2d0690a628237b9bc0f6ed68d47d5f5f17d38ef4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2d0690a628237b9bc0f6ed68d47d5f5f17d38ef4", @"/Views/Purchase/booking.cshtml")]
...
");
            ...
            WriteLiteral(@"                 </span>
                           ...
                           ");
            WriteLiteral(@"     <div>
                                    <input class=""form-control"" name=""Phone"" type=""tel"" placeholder=""請輸入聯絡電話"" v-model=""orderInformation.userInformation.phone"">
                                </div>
                            </div>
                            <!--電子郵件信箱-->
                            <div class=""row mb-3"">
                                ...
                                <div>
                                    <input class=""form-control"" name=""Email"" type=""email"" placeholder=""請輸入常用電子郵件信箱"" v-model=""orderInformation.userInformation.email"">
                                </div>
                      ");
            WriteLiteral(@"      </div>
                        </div>
...
");
         ...
         ");
          ...
          ");
            WriteLiteral(@"                                  </span>
                            ...
                            <!--超商代碼繳費-->
                            <div class=""form-check"">
                                <input class=""form-check-input"" type=""radio"" name=""PayMethod"" id=""CVS"" value=""CVS"" v-model=""orderInformation.userInformation.payMethod"">
                 ...
                 ");
            WriteLiteral("                           </span>\r\n                                        </div>\r\n                                        <div>\r\n                                            <img");
            BeginWriteAttribute("src", " src=\"", 13145, "\"", 13151, 0);
            EndWriteAttribute();
            ...
            WriteLiteral(@"                   </div>
                            ...
                            <div class=""form-check"">
                                <input class=""form-check-input"" type=""radio"" name=""PayMethod"" id=""GooglePay"" value=""GooglePay""
                                       v-model=""orderInformation.userInformation.payMethod"">
    ...
    ");
            WriteLiteral(@"                                    </div>
                            ...
                            <div class=""form-check"">
                                <input class=""form-check-input"" type=""radio"" name=""PayMethod"" id=""creditcard""
                                      v-model=""orderInformation.userInformation.payMethod"" value=""creditcard"">
            ...
            WriteLiteral(@"/div>
                                                ...
                                                <div class=""d-flex justify-content-between"">
                                                    <span");
            BeginWriteAttribute("class", " class=\"", 21637, "\"", 21645, 0);
            EndWriteAttribute();
            WriteLiteral(">\r\n                                                        總金額\r\n                                                    </span>\r\n                                                    <span");
...
");
            WriteLiteral("        </main>\r\n    </div>\r\n</section>\r\n\r\n\r\n\r\n<script>\r\n    var item = [];\r\n</script>\r\n\r\n");
#nullable restore
#line 501 "C:\Users\Tibame_T14\Documents\GitHub\TFM104-4\TFM104MVC\TFM104MVC\Views\Purchase\booking.cshtml"
...
#nullable disable
            WriteLiteral("\');\r\n        </script>\r\n");
#nullable restore
#line 512 "C:\Users\Tibame_T14\Documents\GitHub\TFM104-4\TFM104MVC\TFM104MVC\Views\Purchase\booking.cshtml"
    }
...
<script>
    var app16booking = new Vue({
        ...
        computed: {
            ...
            totalCount: function () {
                return this.orderInformation.checkOutList.len");
            WriteLiteral(@"gth;
            },
            ponits: function () {
        ...
        methods: {
            name: function () {
                return this.orderInformation.userInformation.name = this.lastName + this.firstName;
            },
            addOrder: function () {
                let self = this;
                this.name();
                axios.post(""/api/Cart/Checkout"", self.orderInformation)
                    .then(function (res) {
                        if (res.status == 200) {
                            ...
                            //console.log(self.checkOrderInfo.payMethod);
       ...
       ");
            WriteLiteral(@"                     //訂單編號
                            ...
                            inp1.type = ""text"";
                            inp1.name = ""ordernumber"";
                            inp1.value = self.checkOrderInfo.ordernumber;
                            ...
                            inp2.type = ""number"";
                            inp2.name = ""amount"";
                            inp2.value = self.checkOrderInfo.amount;
                            ...
                            inp3.type = ""text"";
                            inp3.name = ""payMethod"";
                            inp3.value = self.checkOrderInfo.payMethod;
         ...
         ");
            ...
            getUserCheckOutCart: function () {
               ...
               ");
            WriteLiteral(@"                     //self.checkOutList[self.checkOutList.length] = res.data[i];
                                }
                            }
                        }
                    })
            ...
            getUserData: function () {
                ...
                axios.get(""/auth/getUser"").then(
                    function (res) {
                        self.orderInformation.userInformation.email = res.data.account;
                        self.orderInformation.userInformation.phone = res.data.phone;
