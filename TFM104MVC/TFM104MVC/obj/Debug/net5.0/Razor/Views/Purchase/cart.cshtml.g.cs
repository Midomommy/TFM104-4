#pragma checksum "C:\Users\Tibame_T14\Documents\GitHub\TFM104-4\TFM104MVC\TFM104MVC\Views\Purchase\cart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3fda18f46de6d136491771c3e8abd4994385ebc9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3fda18f46de6d136491771c3e8abd4994385ebc9", @"/Views/Purchase/cart.cshtml")]
...
<div class=""container"" id=""ShopCart"">
    ...
    <div class=""row"">
        <div class=""empty-cart"" v-if=""cartList.length ==0"">
            ...
            BeginWriteAttribute("onclick", " onclick=\"", 1602, "\"", 1656, 3);
...
WriteAttributeValue("", 1627, Url.Action("Index", "Home"), 1627, 28, false);
                    ...
                    <div class=""row cart-item"" v-for=""item in cartList"">
                        <div class=""col-1 ckeckbox"">
                            <div class=""form-check"">
                                <input class=""form-check-input"" type=""checkbox"" v-model=""selectedProduct"" :value=""item.id"" :id=""item.id"" checked>
...
<div class=""container g-0 continue-shop"">
    <a id=""continue-shop"" class=""float-end""");
            BeginWriteAttribute("onclick", " onclick=\"", 7857, "\"", 7911, 3);
            WriteAttributeValue("", 7867, "location.href=\'", 7867, 15, true);
#nullable restore
#line 178 "C:\Users\Tibame_T14\Documents\GitHub\TFM104-4\TFM104MVC\TFM104MVC\Views\Purchase\cart.cshtml"
WriteAttributeValue("", 7882, Url.Action("Index", "Home"), 7882, 28, false);
        ...
        methods: {
            getCurrentUserCart: function () {
                ...
                axios.get(""/api/Cart/GetFullInfoCart"")
                    .then(function (res) {
                      ");
            WriteLiteral(@"  if (res.data.length == 0) {
